        ...
        <div className="flex items-center justify-between h-18">
          ...
          <div className="hidden sm:flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-semibold text-white bg-[#1a1c20]/80 hover:bg-[#282a2e] border border-[#a3c9ff]/30 hover:border-[#a3c9ff]/60 transition-all shadow-sm"
            >
              <FileText className="w-4 h-4 text-[#a3c9ff]" />
              <span>Download Resume</span>
            </button>
            <button
              id="nav-btn-contact"
              onClick={onOpenContact}
              className="flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-semibold text-[#111318] bg-[#00dbe7] hover:bg-[#a3c9ff] shadow-lg shadow-[#00dbe7]/30 hover:shadow-[#a3c9ff]/40 transition-all border border-transparent"
            >
